...
<body>
  ...
  <section class="section-1">
    ...
    <div class="home-image">
      <img src="home/rick.png" alt="Exemplo de treino">
    </div>
  </section>
  ...
  <section class="section-1">
    ...
    <div class="right-image">
      <img src="home/ka.webp" alt="Pessoas treinando com cordas" />
    </div>
  </section>
  ...
  <div class="section">
    ...
    <div class="calendar">
      <div class="example">CALENDÁRIO</div>
    </div>
    <a class="btn" href="#">Marcar Avaliação</a>
  </div>

  <!-- Personal Trainers -->
  <div class="section">
    <h2>Personal Trainers</h2>
    <div class="example">EXEMPLO DE IMAGEM</div>
    <a class="btn" href="#">Ver Personais</a>
  </div>
  ...
  <div class="section">
    ...
    <div class="example">EXEMPLO DE IMAGEM</div>
    <a class="btn" href="#">Marcar Consulta</a>
  </div>
  ...
  <div class="section info-boxes">
    <h3>Monte seu Treino</h3>
      <ul style="text-align: left;">
        <li>Treino de Costas</li>
        <li>Treino de Peito</li>
        <li>Treino de Pernas</li>
        <li>Treino de Bíceps/Tríceps</li>
        <li>Treino Funcional</li>
      </ul>
      <a class="btn" href="#">Monte seu treino</a>
    </div>
  </div>
  ...
  <div class="section">
    <h2>Buscar Grupos</h2>
    <div class="example">EXEMPLO DE ÍCONE / INPUT</div>
    <a class="btn" href="#">Buscar Grupo</a>
  </div>
  ...
  <div class="section section-1">
    ...
    <div class="right-image">
      <img src="home/propraganda.png" alt="App" />
    </div>
  </div>
  ...
  <footer class="footer">
    <div class="footer-container">
      <div class="footer-logo">PowerQuest</div>
